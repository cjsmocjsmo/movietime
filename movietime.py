...
class MyFile:
    def __init__(self, media):
        ...
        self.picfolder = "/".join((os.environ["MT_PICPATH"], str(self.name_and_year)))
...
##            return ''.join(('data:image/png;base64,', base64.b64encode(imagefile.read()).decode('utf-8')))
    ...
    def find_movie_art(self):
        ...
        else: return os.environ["MT_NOART_PATH"]
...
if __name__ == "__main__":
    ...
    MEDIAPATHLIST = config.create_media_list()
    EXTLIST = config.create_extension_list()
